...
@app.route('/')
def home():
    return "RS HOSTING BOT IS RUNING"
...
# --- Configuration ---
TOKEN = os.environ.get("BOT_TOKEN") # Replace with your actual token
OWNER_ID = 6621572366 # Replace with your Owner ID
ADMIN_ID = 6621572366 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@RS_WONER' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/CARTOONFUNNY03' # Replace with your update channel link
